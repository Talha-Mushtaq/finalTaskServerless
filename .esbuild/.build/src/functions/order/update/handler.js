...
// src/functions/order/update/handler.ts
__export(exports, {
  main: () => main
});
...
var updateOrder = async (event) => {
  try {
    ...
    const query = {
      ...
      UpdateExpression: "SET products = :products , TotalPrice = :TotalPrice , UserID = :UserID , UserName = :UserName",
